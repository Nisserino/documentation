...
| Entra ID Sign-In Via Known AiTM Phishing Kit (Rockstar 2FA) | elementary | <span style="color:#5865d3"><a href='https://learn.microsoft.com/en-us/sysinternals/downloads/sysmon#events' style='color: inherit;'>15</a></span> |  |
...
| EventID | Number of rules concerned | Percentage of rules concerned (Total rules: 507) |
| ------- | ------------------------- | ------------------------------------------------------ |
| 1 | 236 | 46.55 % |
| 13 | 50 | 9.86 % |
| 4104 | 45 | 8.88 % |
...
| EventProvider | Number of rules concerned | Percentage of rules concerned (Total rules: 507) |
| ------- | ------------------------- | ------------------------------------------------------ |
| Microsoft-Windows-Sysmon | 290 | 57.2 % |
| Microsoft-Windows-Security-Auditing | 87 | 17.16 % |
| Kernel-Process | 58 | 11.44 % |
| Microsoft-Windows-PowerShell | 48 | 9.47 % |
| Service Control Manager | 11 | 2.17 % |
| Microsoft-Windows-Windows Defender | 9 | 1.78 % |
| Microsoft-Windows-Kernel-File | 9 | 1.78 % |
| Microsoft-Windows-Kernel-Network | 3 | 0.59 % |
| Microsoft-Windows-Kernel-Process | 2 | 0.39 % |
| Microsoft-Windows-DHCP-Server | 2 | 0.39 % |
| Microsoft-Windows-DNS-Client | 2 | 0.39 % |
...
| Effort Level | EventIDs | Number of related rules | Percentage of related rules (Total rules: 507 |
| ------------ | -------- | ----------------------- | ------------------------------------------------------- |
| master | 1, 10, 1013, 11, 1116, 12, 13, 15, 150, 17, 22, 25, 27, 3, 40, 4104, 4611, 4624, 4625, 4649, 4656, 4661, 4662, 4663, 4673, 4674, 4688, 4720, 4726, 4728, 4729, 4732, 4740, 4743, 4768, 5, 5007, 5140, 5145, 64, 7, 79016668, 8001, 83820799, 98 | 134 | 26.43 % |
| advanced | 1, 10, 11, 1116, 1127, 13, 15, 17, 21, 22, 23, 25, 3, 4103, 4104, 4624, 4625, 4656, 4662, 4688, 4706, 4707, 4799, 5, 5145, 5154, 5156, 6, 6416, 7, 7045, 8 | 113 | 22.29 % |
| intermediate | 1, 10, 1000, 1033, 1034, 11, 1102, 12, 13, 15, 16, 17, 20, 22, 3, 30, 4103, 4104, 4624, 4656, 4657, 4662, 4663, 4688, 4697, 4698, 47, 4703, 4720, 4738, 4741, 4768, 4794, 4825, 5, 5136, 5145, 524, 6, 7, 7045, 8 | 161 | 31.76 % |
| elementary | 1, 10, 11, 1116, 13, 15, 17, 25, 325, 4103, 4104, 4625, 4663, 4688, 4697, 4704, 4720, 4738, 4887, 5, 5136, 5145, 7, 7045, 8 | 99 | 19.53 % |